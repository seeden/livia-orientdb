...
_livia.Type.RID = _RID2['default'];
_livia.Type.Linked = _Linked2['default'];
_livia.Type.Double = _Double2['default'];
_livia.Type.Long = _Long2['default'];

exports['default'] = _livia.Type;
